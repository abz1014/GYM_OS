...
public record DietPlanListItemDto(
    Guid Id, string Name, decimal? TargetCalories, decimal? TargetProteinG, decimal? TargetCarbsG, decimal? TargetFatG,
    DateOnly StartDate, DateOnly? EndDate);

public record DietPlanDetailDto(
    Guid Id, Guid MemberId, string Name, decimal? TargetCalories, decimal? TargetProteinG, decimal? TargetCarbsG, decimal? TargetFatG,
    DateOnly StartDate, DateOnly? EndDate, IReadOnlyList<MealEntryDto> MealEntries);
